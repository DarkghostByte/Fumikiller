    ...
    <div>
        <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-start" >
          <div class="flex flex-wrap items-start justify-end ">
            ...
            <!--RUTAS ENTRES VISTAS-->
            <router-link to="/admin/home" class="inline-flex px-5 py-3 text-white bg-red-400 hover:bg-red-700 focus:bg-red-800 rounded-md ml-6 mb-3"
            style="color:black">
            ...
            <router-link to="/admin/ventas" class="inline-flex px-5 py-3 text-white bg-amber-400 hover:bg-amber-700 focus:bg-amber-900 rounded-md ml-6 mb-3"
            style="color:black">
              <i class="fa fa-pdf" aria-hidden="true" style="margin-top: 5px;
              margin-left: -5px; margin-right:10px;"></i>                
              Generar PDF
            </router-link>
        ...
        <div class="mr-6">
          <h1 class="py-10 px-5 text-4xl font-semibold mb-2">Ventas Sin Factura</h1>
        </div>
        ...
        <div class="flex">
            ...
            <el-table-column prop="requiere3" label="Datos" sortable width="200" />
